...
public class UnderstanderDemo extends Activity implements OnClickListener {
	...
	public void onClick(View view) {
		...
		if (i == R.id.image_understander_set) {
			...
			// 开始语音理解
		} else if (i == R.id.start_understander) {
			mUnderstanderText.setText("");
			// 设置参数
			setParam();
			...
			// 停止语音理解
		} else if (i == R.id.understander_stop) {
			mSpeechUnderstander.stopUnderstanding();
			showTip("停止语义理解");

			// 取消语音理解
		} else if (i == R.id.understander_cancel) {
